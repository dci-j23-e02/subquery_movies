...
//   movieDao.findActorsForMoviesNotInYear(2000).forEach(System.out::println);
    System.out.println("ACTORS BY MOVIE RELEASE YEARS 2020, 2005,1994");
    movieDao.findActorsByMovieReleaseYears(List.of(2020,2005,1994)).forEach(System.out::println);
